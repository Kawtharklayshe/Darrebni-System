...
careerStore.fetchcareerById(Number(route.params.id)).then(response => {
...
const onSubmit = () => {
  refForm.value?.validate().then(({ valid }) => {
    if (valid) {
      loading.value = true
      careerStore.updatecareer(career.value).then(res => {
        swal({
          title: ' Updated ',
          icon: 'success',
          customClass: {
                ...
                <VCard title=" image ">
                  <VCardText>
                    ...
                    <VAvatar
                      ...
                      :size="200"
                      class="me-6"
                      :image="`https://prokoders.academy/${career.image}`"
                    />
                  </VCardText>
                </VCard>
                ...
                <VCard title="Seo Image ">
                  <VCardText>
                    ...
                    <VAvatar
                      ...
                      :size="200"
                      class="me-6"
                      :image="`https://prokoders.academy/${career.seo.og_image}`"
                    />
                  </VCardText>
                </VCard>
                <div class="d-flex flex-wrap gap-2 mt-10">
