    ...
    if (valid) {
      ...
      courseStore.addcourse(course.value).then(res => {
        ...
        nextTick(() => {
          ...
          loading.value = false
          course.value.first_image = 'img/deflate.jpg'
          course.value.seo_og_image = 'img/deflate.jpg'
          course.value.image = 'img/deflate.jpg'
          refForm.value?.reset()
                  ...
                  <VCard title="First image ">
                    <VCardText>
                      ...
                      <VAvatar
                        ...
                        :size="200"
                        class="me-6"
                        :image="`https://prokoders.academy/${course.first_image}`"
                      />
                    </VCardText>
                  </VCard>
                  ...
                  <VCard title=" image ">
                    <VCardText>
                      ...
                      <VAvatar
                        ...
                        :size="200"
                        class="me-6"
                        :image="`https://prokoders.academy/${course.image}`"
                      />
                    </VCardText>
                  </VCard>
                  <div class="d-flex flex-wrap gap-2 mt-10">
                  ...
                  <VCard title=" Video ">
                    <VCardText>
                      ...
                      <video
                        ...
                        :src="`https://prokoders.academy/${course.video}`"
                        :controls="true"
                        class="me-6"
                        width="200"
                        height="200"
                ...
                <VCard title="Seo Image ">
                  <VCardText>
                    ...
                    <VAvatar
                      ...
                      :size="200"
                      class="me-6"
                      :image="`https://prokoders.academy/${course.seo.og_image}`"
                    />
                  </VCardText>
                </VCard>
                <div class="d-flex flex-wrap gap-2 mt-10">
