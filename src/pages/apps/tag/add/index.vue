...
const uploadNewImage = (i: any) => {
  ...
  tagStore.uploadImage(fd).then((response: any) => {
    loading.value = false
    tag.value.image = response?.data.path_file
  })
}
...
const uploadSeoImage = (i: any) => {
  ...
  tagStore.uploadImage(fd).then((response: any) => {
    loading.value = false
    tag.value.seo.og_image = response?.data.path_file
  })
}
...
const onSubmit = () => {
  refForm.value?.validate().then(({ valid }) => {
    if (valid) {
      loading.value = true
      tagStore.addtag(tag.value).then(res => {
        swal({
          title: ' Added ',
          icon: 'success',
          customClass: {
                ...
                <VCard title=" image ">
                  <VCardText>
                    ...
                    <VAvatar
                      ...
                      :size="200"
                      class="me-6"
                      :image="`https://b2b.prokoders.space/${tag.image}`"
                    />
                  </VCardText>
                </VCard>
                ...
                <VCard title="Seo Image ">
                  <VCardText>
                    ...
                    <VAvatar
                      ...
                      :size="200"
                      class="me-6"
                      :image="`https://b2b.prokoders.space/${tag.seo.og_image}`"
                    />
                  </VCardText>
                </VCard>
                <div class="d-flex flex-wrap gap-2 mt-10">
