export default [
  ...
  },
  {
    ...
    icon: { icon: 'tabler-users' },
    children: [
      { title: 'اضافة', to: 'apps-trainee-add' },
      { title: 'قائمة المتدربين', to: 'apps-trainee-list' },
  ...
  },
  {
    ...
    icon: { icon: 'tabler-users' },
    children: [
      { title: 'اضافة', to: 'apps-employee-add' },
      { title: 'قائمة الموظفين', to: 'apps-employee-list' },
  ...
  },
  {
    ...
    children: [
      { title: 'اضافة', to: "apps-payments-add" },
  ...
  },
  {
    ...
    children: [
      { title: 'اضافة', to: "apps-courses-add" },
  ...
  },
  {
    ...
    children: [
      { title: 'اضافة', to: "apps-specializetions-add" },
